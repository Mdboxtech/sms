...
export default function SubjectResults({ auth, subject, results }) {
    ...
    if (results && results.length > 0) {
        results.forEach(result => {
            ...
            resultsByTerm[termId].results.push(result);
        });
    }
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<PageHeader>Subject Results: {subject?.name}</PageHeader>}
        >
            <Head title={`${subject?.name} Results - SMS`} />
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="mb-6 flex justify-between items-center">
                        ...
                        <Link
                            href={route('admin.results.export', { subject_id: subject?.id })}
                    ...
                    <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
                        <div className="px-4 py-5 sm:px-6">
                            ...
                            <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                Performance overview for {subject?.name}
                            </p>
                        </div>
                    ...
                    {Object.keys(resultsByTerm).length === 0 && (
                        <Card>
                            <div className="p-6 text-center">
                                <p className="text-gray-500">No results found for this subject.</p>
                            </div>
                        </Card>
                    )}
                </div>
