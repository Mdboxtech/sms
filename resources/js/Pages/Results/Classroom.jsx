...
export default function ClassroomResults({ auth, classroom, results }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<PageHeader>Class Results: {classroom?.name}</PageHeader>}
        >
            <Head title={`${classroom?.name} Results - SMS`} />
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="mb-6 flex justify-between items-center">
                        ...
                        <Link
                            href={route('admin.results.export', { classroom_id: classroom?.id })}
                    ...
                    <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
                        <div className="px-4 py-5 sm:px-6">
                            ...
                            <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                Performance overview for {classroom?.name}
                            </p>
                        </div>
                        ...
                        <Card key={student.id} className="mb-6">
                            <div className="p-6">
                                <div className="flex justify-between items-center mb-4">
                                    <div>
                                        <h2 className="text-xl font-semibold text-gray-800">{student.user.name}</h2>
                                                    ...
                                                    <tr key={result.id}>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <div className="text-sm text-gray-900">
                                                                {result.term ? `${result.term.academic_session?.name || ''} - ${result.term.name}` : 'Unknown'}
                                                            </div>
                                                        </td>
                                                        <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    {Object.keys(groupedResults).length === 0 && (
                        <Card>
                            <div className="p-6 text-center">
                                <p className="text-gray-500">No results found for this classroom.</p>
                            </div>
                        </Card>
                    )}
                </div>
