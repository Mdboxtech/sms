...
import { Save, ArrowLeft, AlertCircle, Calendar, DollarSign } from 'lucide-react';
...
export default function Create({ 
    ...
    const getCurrentSession = () => {
        return safeAcademicSessions.find(session => session.is_current) || safeAcademicSessions[0];
    };

    const getCurrentTerm = () => {
        return safeTerms.find(term => term.is_current) || safeTerms[0];
    };
    ...
    React.useEffect(() => {
        ...
        if (currentSession && !data.academic_session_id) {
            setData('academic_session_id', currentSession.id);
        }
        
        if (currentTerm && !data.term_id) {
            setData('term_id', currentTerm.id);
        }
    }, [safeAcademicSessions, safeTerms]);
            ...
            <div className="py-6">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="mt-4">
                            <h1 className="text-3xl font-bold text-gray-900">Create New Fee</h1>
                            <p className="mt-2 text-gray-600">
                                Set up a new fee for students to pay
                            </p>
                        </div>
                    </div>
