...
export default function Index({ 
    ...
    const handleSearch = () => {
        router.get(route('admin.cbt.questions.index'), {
            search: searchTerm,
    ...
    const handleDelete = (questionId) => {
        if (confirm('Are you sure you want to delete this question?')) {
            router.delete(route('admin.cbt.questions.destroy', questionId), {
                onSuccess: () => {
            ...
            render: (question) => (
                <div className="flex space-x-2">
                    <Button
                        variant="outline"
                        size="sm"
                        onClick={() => router.get(route('admin.cbt.questions.show', question.id))}
                    >
                        View
                    </Button>
                    <Button
                        variant="outline"
                        size="sm"
                        onClick={() => router.get(route('admin.cbt.questions.edit', question.id))}
                    >
                        Edit
                    </Button>
                    <Button
