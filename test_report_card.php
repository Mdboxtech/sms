...
// Simple test script to check if report card can be generated
...
try {
    ...
    echo "Testing Report Card Generation:\n";
    echo "Term: {$term->name}\n";
    echo "Student: {$student->user->first_name} {$student->user->last_name}\n";

    $service = new ReportCardService();
    
    // Try to generate the PDF (this will test our school_info fix)
