...
class SettingsController extends Controller
{
    public function index()
    {
        ...
        $reportCardSettings = [
            'report_card_template' => Setting::getValue('report_card_template', 'classic'),
            'report_card_color_theme' => Setting::getValue('report_card_color_theme', 'school_colors'),
            'report_card_show_attendance' => Setting::getValue('report_card_show_attendance', true),
            'report_card_show_position' => Setting::getValue('report_card_show_position', true),
            'report_card_show_class_average' => Setting::getValue('report_card_show_class_average', true),
            'report_card_show_teacher_comment' => Setting::getValue('report_card_show_teacher_comment', true),
            'report_card_show_principal_comment' => Setting::getValue('report_card_show_principal_comment', true),
            'report_card_header_text' => Setting::getValue('report_card_header_text', 'STUDENT REPORT CARD'),
            'report_card_disclaimer' => Setting::getValue('report_card_disclaimer', 'This result is generated by the school management system and is subject to errors and omissions.'),
            'report_card_notable_attributes' => Setting::getValue('report_card_notable_attributes', false),
            'report_card_table_header_color' => Setting::getValue('report_card_table_header_color', '#1e40af'),
            'report_card_table_border_color' => Setting::getValue('report_card_table_border_color', '#e2e8f0'),
        ];
    ...
    public function updateReportCard(Request $request)
    {
        $request->validate([
            'report_card_template' => 'required|string|in:classic,modern,professional',
            'report_card_color_theme' => 'required|string',
            'report_card_show_attendance' => 'boolean',
            'report_card_show_position' => 'boolean',
            'report_card_show_class_average' => 'boolean',
            'report_card_show_teacher_comment' => 'boolean',
            'report_card_show_principal_comment' => 'boolean',
            'report_card_header_text' => 'nullable|string|max:100',
            'report_card_disclaimer' => 'nullable|string|max:500',
            'report_card_notable_attributes' => 'boolean', // Values like Honest, Kind, etc.
            'report_card_table_header_color' => 'nullable|string|regex:/^#[0-9A-Fa-f]{6}$/',
            'report_card_table_border_color' => 'nullable|string|regex:/^#[0-9A-Fa-f]{6}$/',
        ]);
        ...
        try {
            ...
            $settings = [
                ...
                'report_card_show_attendance',
                'report_card_show_position',
                'report_card_show_class_average',
                'report_card_show_teacher_comment',
                'report_card_show_principal_comment',
                'report_card_header_text',
                'report_card_disclaimer',
                'report_card_notable_attributes',
                'report_card_table_header_color',
                'report_card_table_border_color'
            ];
            ...
            return redirect()->route('admin.settings.index')
                ->with('error', 'Failed to update report card settings: ' . $e->getMessage());
        }
    }
